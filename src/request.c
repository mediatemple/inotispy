...
char *
request_get_key_str (Request *req, char *key)
{
    JOBJ val;

    LOG_TRACE("Calling request_get_key_str(): json='%s' key='%s'", req->json, key);
 ...
 */
int
request_get_key_int (Request *req, char *key)
{
    JOBJ val;

    LOG_TRACE("Calling request_get_key_int(): json='%s' key='%s'", req->json, key);
...
int
request_get_max_events (Request *req)
{
    int max_events;
